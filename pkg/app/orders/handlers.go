...
import (
	...
	amazonpay "github.com/qorpress/amazon-pay-sdk-go"
	"github.com/qorpress/gomerchant"
	qorrender "github.com/qorpress/render"
...
func (ctrl Controller) CompleteCreditCard(w http.ResponseWriter, req *http.Request) {
	...
	if creditCard.ValidNumber() {
		// TODO integrate with https://github.com/qorpress/gomerchant to handle those information
		tx := utils.GetDB(req)
		err := orders.OrderState.Trigger("checkout", order, tx, "")

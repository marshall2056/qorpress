...
[![GoDoc](https://godoc.org/github.com/qorpress/serializable_meta?status.svg)](https://godoc.org/github.com/qorpress/serializable_meta)

## Usage

The example herein shows how to manage different kinds of background jobs using https://github.com/qorpress/serializable_meta.
...
Add function `GetSerializableArgumentResource` to the model, so [Serializable Meta](https://github.com/qorpress/serializable_meta) can know the type of argument. Then define background jobs.

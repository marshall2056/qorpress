...
### Initialize [Render](https://github.com/qorpress/render)

```go
import "github.com/qorpress/render"
...
1. The template name. In this example [Render](https://github.com/qorpress/render) will look up template `index.tmpl` from view paths. the default view path is `{current_repo_path}/app/views`, and you could register more view paths.
...
[Render](https://github.com/qorpress/render) will find the layout at `{current_repo_path}/app/views/layouts/new_layout.tmpl`.

### Render with helper functions

Sometimes you may want to have some helper functions in your template. [Render](https://github.com/qorpress/render) supports passing helper functions by `Funcs` function.
...
Put the [Render](https://github.com/qorpress/render) inside [Responder](./responder.md) handle function like this.

...
[![GoDoc](https://godoc.org/github.com/qorpress/l10n?status.svg)](https://godoc.org/github.com/qorpress/l10n)
...
Although L10n could be used alone, it integrates nicely with [QOR](https://github.com/qorpress/qor).

[L10n Demo with QOR](http://demo.getqor.com/admin/products)

By default, [QOR](https://github.com/qorpress/qor) will only allow you to manage the global language. If you have configured [Authentication](http://doc.getqor.com/admin/authentication.html), [QOR Admin](http://github.com/qorpress/admin) will try to obtain the allowed Locales from the current user.

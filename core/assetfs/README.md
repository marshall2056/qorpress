...
If you want to compile all required files into a binary and load files from from binary, you could refer our [bindatafs](http://github.com/qorpress/bindatafs)

# Usage

```go
import "github.com/qorpress/assetfs"

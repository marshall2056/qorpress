...
import (
	...
	"github.com/qorpress/qorpress/core/auth/providers/password/encryptor"
	"github.com/qorpress/qorpress/core/auth/providers/password/encryptor/bcrypt_encryptor"
...
func (provider Provider) ConfigAuth(auth *auth.Auth) {
	auth.Render.RegisterViewPath("github.com/qorpress/qorpress/core/auth/providers/password/views")

	if auth.Mailer != nil {
		auth.Mailer.RegisterViewPath("github.com/qorpress/qorpress/core/auth/providers/password/views/mailers")
	}
}

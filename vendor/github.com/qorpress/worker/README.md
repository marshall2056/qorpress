...
Once registered with [QOR Admin](http://github.com/qorpress/admin), [Worker](https://github.com/qorpress/worker) will provide a `Workers` section in the navigation tree, containing pages for listing and managing the following aspects of Workers:
...
[![GoDoc](https://godoc.org/github.com/qorpress/worker?status.svg)](https://godoc.org/github.com/qorpress/worker)

## Usage

```go
import "github.com/qorpress/worker"
